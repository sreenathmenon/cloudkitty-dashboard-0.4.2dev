...
from openstack_dashboard.dashboards.identity.xprojects import workflows
...
class TenantsViewTests(test.BaseAdminViewTests):
    ...
    def test_index(self):
        ...
        self.assertTemplateUsed(res, 'identity/xprojects/index.html')
...
class CreateProjectWorkflowTests(test.BaseAdminViewTests):
    ...
    def test_add_project_get(self):
        ...
        url = reverse('horizon:identity:xprojects:create')
    ...
    def test_add_project_get_with_neutron(self):
        ...
        res = self.client.get(reverse('horizon:identity:xprojects:create'))
...
class UpdateProjectWorkflowTests(test.BaseAdminViewTests):
    ...
    def test_update_project_get(self):
        ...
        url = reverse('horizon:identity:xprojects:update',
                      args=[self.tenant.id])
        res = self.client.get(url)
...
class UsageViewTests(test.BaseAdminViewTests):
    ...
    def _test_usage_csv(self, nova_stu_enabled=True):
        ...
        csv_url = reverse('horizon:identity:xprojects:usage',
...
class DetailProjectViewTests(test.BaseAdminViewTests):
    ...
    def test_detail_view(self):
        ...
        self.assertTemplateUsed(res, 'identity/xprojects/detail.html')
    ...
    def test_membership_list_loads_correctly(self):
        ...
        self.selenium.get("%s%s" %
                          (self.live_server_url,
                           reverse('horizon:identity:xprojects:create')))
