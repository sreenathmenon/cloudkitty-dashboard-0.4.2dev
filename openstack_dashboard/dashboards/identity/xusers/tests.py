...
USERS_INDEX_URL = reverse('horizon:identity:xusers:index')
USER_CREATE_URL = reverse('horizon:identity:xusers:create')
USER_UPDATE_URL = reverse('horizon:identity:xusers:update', args=[1])
USER_DETAIL_URL = reverse('horizon:identity:xusers:detail', args=[1])
USER_CHANGE_PASSWORD_URL = reverse('horizon:identity:xusers:change_password',
                                   args=[1])
...
class UsersViewTests(test.BaseAdminViewTests):
    ...
    def test_index(self):
        ...
        self.assertTemplateUsed(res, 'identity/xusers/index.html')
    ...
    def test_detail_view(self):
        ...
        self.assertTemplateUsed(res, 'identity/xusers/detail.html')
